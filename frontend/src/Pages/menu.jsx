...
function MenuPage() {
  ...
  const fetchProducts = async () => {
    try {
      const type1Response = await axios.get('http://localhost:5002/api/products/Type-1');
      setType1Products(type1Response.data);

      const type2Response = await axios.get('http://localhost:5002/api/products/Type-2');
      setType2Products(type2Response.data);

      const type3Response = await axios.get('http://localhost:5002/api/products/Type-3');
    ...
    <div className="menu-page">
      ...
      <div className='section-1'>
        <div className='section-1-heading'>
          ...
          <Link to="/products/Type-1" className="view-all-button">View All Type 1 Products</Link> {/* Navigation button */}
        </div>
      ...
      <div className='section-2'>
        <div className='section-2-heading'>
          ...
          <Link to="/products/Type-2" className="view-all-button">View All Type 2 Products</Link> {/* Navigation button */}
        </div>
